            ...
            <div key={index} className="glass-effect rounded-3xl overflow-hidden card-hover">
              <div className={`grid grid-cols-1 lg:grid-cols-2 gap-0 ${index % 2 === 1 ? 'lg:grid-flow-col-dense' : ''}`}>
                ...
                <div className={`p-8 md:p-12 ${career.bgColor} ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                  ...
                  {/* CTA */}
                  <button className="btn-primary group" onClick={scrollToContact}>
        ...
        <div className="text-center mt-20">
          <div className="bg-gradient-to-r from-[#0041c9] to-[#1a57d6] rounded-3xl p-8 md:p-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-white text-[#0041c9] hover:bg-gray-100 font-semibold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg" onClick={scrollToContact}>
                Book Free Consultation
              </button>
              <button className="border-2 border-white text-white hover:bg-white hover:text-[#0041c9] font-semibold py-4 px-8 rounded-xl transition-all duration-300" onClick={scrollToContact}>
                Compare All Courses
              </button>
            </div>
          </div>
